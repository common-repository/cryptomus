...
add_action( 'woocommerce_blocks_loaded', 'cryptomus_register_order_approval_payment_method_type' );
/**
 * Custom function to register a payment method type
 */
function cryptomus_register_order_approval_payment_method_type() {
    ...
    add_action(
        ...
        function( Automattic\WooCommerce\Blocks\Payments\PaymentMethodRegistry $payment_method_registry ) {
            $payment_method_registry->register( new Cryptomus_Gateway_Blocks );
        }
    );
}
